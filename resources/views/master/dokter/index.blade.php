                ...
                <form id="form_edit_id" action="<?php echo url($route.'/search') ?>" method="post" class="form-horizontal">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" id="name" class="form-control input-sm" value="{{ $search['name'] }}" placeholder="Nama Dokter">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" id="alamat" class="form-control input-sm" value="{{ $search['alamat'] }}" placeholder="Alamat Dokter">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="telepon" id="telepon" class="form-control input-sm" value="{{ $search['telepon'] }}" placeholder="Telepon Dokter">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="pekerjaan" class="col-sm-3 control-label">Jenis Dokter</label>
                            <div class="col-sm-9">
                                <input type="text" name="pekerjaan" id="pekerjaan" class="form-control input-sm" value="{{ $search['jenis'] }}" placeholder="Jenis Dokter">
                            </div>
                        </div>
                        ...
                        <div class="pull-right text-center">
                            ...
                            <a href="<?=route('dokter',$param)?>&export=true" class="btn btn-success btn-sm" target="_blank"><i class="fa fa-save"></i> Export</a>
...
@endsection
@section('js')
<script src="{{ asset('js/master/dokter.js') }}"></script>
@stop